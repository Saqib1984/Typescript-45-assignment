...
let languages = ["Arabic", "Urdu", "English", "Chineese", "French", "Japnese", "Turkish", "Sindhi"];
languages.forEach(language => { console.log(language); });
// Exercise 21.
// They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
let objectHomeApplication = {
    "split": {
        name: "split",
        price: "100000",
...
let currentUsers = ["Ali", "Saqib", "admin", "Hamza", "Khawar"];
let newUsers = ["Ali", "Khawar", "admin", "Tariq", "Owais"];
let currentUsers_lower = currentUsers.map(user => user.toLocaleLowerCase());
...
let numbersAll = [1, 2, 3, 4, 5, 6, 7, 8, 9];
...
let favPizza = ["BBQ Chicken", "Pepperoni", "Vegetable", "Pesto Chicken"];
...
let animals_pet = ["Dog", "Cat", "Cow", "Horse"];
// Print each animal
...
function show_magicians_4(magicians) {
    for (let magician of magicians) {
        console.log(magician.charAt(0).toLocaleUpperCase() + magician.slice(1));
    }
}
let magician = ["Khawar", "Safi", "Owais", "Kabeer"];
...
let magician1 = ["Khawar", "Safi", "Owais", "Kabeer"];
...
let magicians = ["Khawar", "Safi", "Owais", "Kabeer"];
...
let mycar = createcar("Nissan", "Suzuki", { color: "White", year: "2022" });
console.log(mycar);
